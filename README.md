...
| 📚 **内置精挑题库** | 出厂自带 12+ 道情境谜题（经典改写 + 原创），每题配 **三条不同角度** 的提示，覆盖悬疑、推理与反转。 |
...
- **身份无感**：网页端首次打开自动生成匿名身份，不出现注册 / 登录页；B 站小程序走官方 OAuth；同一名玩家可以跨平台累计投稿。
...
- 想体验 AI 主持人的玩家；
- 想做 **小红书 / B 站小游戏** 的独立开发者（把这份代码当后端 + 题库管理，自己写壳）；
