...
export const copy = {
  zh: {
    ...
    createTitle: '出一道海龟汤', createRemote: '提交后先审核，通过即可分享。', createLocal: '本地创建的题目仅在当前页面可用。', title: '题目名称', titleExample: '例如：消失的钥匙', story: '汤面', storyPlaceholder: '玩家最先看到的故事', answerField: '汤底', answerPlaceholder: '完整真相', hint1: '提示一', hint1Placeholder: '给卡住的玩家一点方向', hint2: '提示二（选填）', hint2Placeholder: '换个角度再给一条', hint3: '提示三（选填）', hint3Placeholder: '最后一条提示', reviewing: '审核中…', submitReview: '提交审核', createOffline: '本地创建', play: '开局', records: '记录', create: '出题',
    authWait: '身份正在初始化，请稍后再试。', questionFailed: '判断失败，稍后再试。', unsureReply: '这题我拿不准，换个问法试试。', shareUnavailable: '这道题只保存在当前页面，连接后端保存后才能分享。', shared: '分享链接已复制，发给朋友即可开局。', answerFailed: '汤底获取失败，稍后再试。', createLocalNotice: '本地题目已创建，连接后端后才能公开。', reviewFailed: '审核暂时失败，题目没有公开，请稍后再试。', feedFailed: '公开题库加载失败，请刷新页面重试。', sharedMissing: '分享的题目不存在或已下架。', localMissing: '这道题尚未保存到题库，无法通过链接打开。', sessionExpired: '平台身份已失效，请重新打开小程序。', invalidPlatform: '平台身份类型无效，请重新打开小程序。', platformFailed: '身份初始化失败，请刷新页面重试。', platformMissingCode: '平台身份初始化失败，请重新打开小程序。', toyProfileFailed: '没有拿到你的 B 站身份，本局进度只保存在本机。',
  },
  en: {
    ...
    authWait: 'Signing you in. Please wait.', questionFailed: 'Jev could not decide. Please try again later.', unsureReply: 'I am not sure. Try asking another way.', shareUnavailable: 'This puzzle exists only on this page. Save it online before sharing.', shared: 'Link copied. Send it to a friend!', answerFailed: 'Could not load the answer. Please try again.', createLocalNotice: 'Local puzzle created. Connect a backend to publish it.', reviewFailed: 'Review is temporarily unavailable. Your puzzle was not published.', feedFailed: 'Could not load the library. Please refresh.', sharedMissing: 'This shared puzzle is unavailable.', localMissing: 'This puzzle is not saved in the library.', sessionExpired: 'Your platform session expired. Please reopen the mini app.', invalidPlatform: 'Unknown platform identity. Please reopen the mini app.', platformFailed: 'Sign-in failed. Please refresh.', platformMissingCode: 'Sign-in failed. Please reopen the mini app.', toyProfileFailed: 'Could not read your Bilibili identity. Progress will only be saved on this device.',
  },
} as const;
