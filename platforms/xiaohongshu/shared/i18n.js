/** 由 pnpm sync:xiaohongshu 从 Web 文案生成，请修改 lib/i18n.ts。 */
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.copy = void 0;
exports.displayOutcome = displayOutcome;
...
function displayOutcome(value, language) {
    if (!value)
        return '';
    const index = ['破解成功', '接近真相', '还没猜对', '无法确定', 'Solved', 'Close', 'Not yet', 'Uncertain'].indexOf(value);
    if (index < 0)
        return value;
    return [exports.copy[language].solved, exports.copy[language].close, exports.copy[language].notYet, exports.copy[language].uncertain][index % 4];
}
